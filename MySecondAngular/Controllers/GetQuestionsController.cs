...
namespace MySecondAngular.Controllers
{
    ...
    {
        private readonly ILogger<GetQuestionsController> _logger;

        public GetQuestionsController(ILogger<GetQuestionsController> logger)
        {
            _logger = logger;
        }
        ...
        public List<Question> Get()
        {
            ...
            SqlDataAdapter Adapter = new SqlDataAdapter($"Select Top 15 * From Questions Order By ID DESC", SQL.con);
