...
namespace MySecondAngular.Controllers
{
    ...
    {
        private readonly ILogger<RandomQuesController> _logger;

        public RandomQuesController(ILogger<RandomQuesController> logger)
        {
            _logger = logger;
        }
        ...
        public List<Question> Get()
        {
            ...
            SqlDataAdapter Adapter = new SqlDataAdapter($"Select Top 5 * From Questions Order By Rand();", SQL.con);
