...
namespace MySecondAngular.Controllers
{
    ...
    {
        private readonly ILogger<ProfileQuestionsController> _logger;

        public ProfileQuestionsController(ILogger<ProfileQuestionsController> logger)
        {
            _logger = logger;
        }
        ...
        public List<Question> Get()
        {
            ...
            string ProfileID = Request.Query["proid"];

            SqlDataAdapter Adapter = new SqlDataAdapter($"Select Top 5 * From Questions Where OwnerID = '{ProfileID}' Order By ID DESC", SQL.con);
